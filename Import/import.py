...
response = session.post("https://SADMIN:SADMIN2017@100.100.181.24:8481/siebel/v1.0/migration/execution/IR_Import", headers=headers, json=data, verify=False)
